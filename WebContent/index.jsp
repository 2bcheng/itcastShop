			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProducts }" var="pro">
					...
					<div class="col-md-2"
						...
						<p>
							<a href="${pageContext.request.contextPath }/product?method=productByPid&pid=${pro.pid}"  style='color: #666'>${pro.pname }</a>
						</p>
						<p>
