...
<script type="text/javascript">
	$(function() {
		...
		$("#checkCode1").blur(function() {
			$.post("${pageContext.request.contextPath}/checkCodeImg", {
				"checkCode" : $("#checkCode1").val()
			}, function(data) {
				if (!data.isTrue) {
	...
	function change(obj) {
		obj.src = "${pageContext.request.contextPath}/checkCode?"
				+ Math.random();
	}
</script>
</head>
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								...
								name="sex" id="sex2" value="famale"> 女
							</label>
						</div>
					</div>
					<div class="form-group">
